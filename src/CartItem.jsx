  ...
  return (
    <div className="cart-container">
          ...
          <div className="cart-item" key={item.name}>
            ...
            <div className="cart-item-details">
              ...
              <div className="cart-item-quantity">
                <button className="cart-item-button" onClick={() => dispatch(updateQuantity({name: item.name, quantity: item.quantity - 1}))}>-</button>
      ...
      <div className="continue_shopping_btn">
        ...
        <button className="get-started-button1" onClick={() => alert('Próximamente')}>Checkout</button>
      </div>
    </div>
  );
};
